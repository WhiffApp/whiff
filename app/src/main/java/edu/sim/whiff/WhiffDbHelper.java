...
public class WhiffDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_TABLE_CAPTURE =
            "CREATE TABLE " + WhiffDbContract.CaptureTable.TABLE_NAME + " (" +
                    ...
                    WhiffDbContract.CaptureTable.COLUMN_NAME_STARTTIME      + " NUMERIC," +
                    WhiffDbContract.CaptureTable.COLUMN_NAME_ENDTIME        + " NUMERIC)";

    private static final String SQL_CREATE_TABLE_CAPTUREDATA =
            "CREATE TABLE " + WhiffDbContract.CaptureDataTable.TABLE_NAME + " (" +
                    WhiffDbContract.CaptureDataTable._ID                    + " INTEGER PRIMARY KEY," +
                    WhiffDbContract.CaptureDataTable.COLUMN_NAME_CAPTUREID  + " INTEGER," +
                    WhiffDbContract.CaptureDataTable.COLUMN_NAME_TIMESTAMP  + " NUMERIC," +
                    WhiffDbContract.CaptureDataTable.COLUMN_NAME_SRCADDRESS + " TEXT," +
                    WhiffDbContract.CaptureDataTable.COLUMN_NAME_SRCPORT    + " INTEGER," +
                    WhiffDbContract.CaptureDataTable.COLUMN_NAME_DSTADDRESS + " TEXT," +
                    WhiffDbContract.CaptureDataTable.COLUMN_NAME_DSTPORT    + " INTEGER," +
                    WhiffDbContract.CaptureDataTable.COLUMN_NAME_PROTOCOL   + " TEXT," +
                    WhiffDbContract.CaptureDataTable.COLUMN_NAME_LENGTH     + " INTEGER)";
    ...
    private static final String SQL_DELETE_TABLE_CAPTUREDATA =
            "DROP TABLE IF EXISTS " + WhiffDbContract.CaptureDataTable.TABLE_NAME;
