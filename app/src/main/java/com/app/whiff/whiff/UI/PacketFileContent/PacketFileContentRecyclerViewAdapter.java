...
public class PacketFileContentRecyclerViewAdapter extends RecyclerView.Adapter<PacketFileContentRecyclerViewAdapter.ViewHolder> {
    ...
    public PacketFileContentRecyclerViewAdapter(Context context, List<CaptureItem> data) {
